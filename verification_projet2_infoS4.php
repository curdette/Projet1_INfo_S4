...
if(isset($_POST['username']) && isset($_POST['password']))
{
 ...
 header('Location: principale.php');//utilisateur ou mot de passe incorrect ici jsp si ça va marcher pour id_membre et mail ?? 
 }
 else
 {
 header('Location: login.php?erreur=1'); // utilisateur ou mot de passe incorrect ici jsp si ça va marcher pour id_membre et mail ?? 
 }
 }
 else
 {
